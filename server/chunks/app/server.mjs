...
const components = {};
function components_411546d2(nuxtApp) {
...
const vueuseHead_436a17c5 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_4f09f9b9 = defineNuxtPlugin((nuxtApp) => {
...
const routes = [
  {
    name: "index",
    path: "/",
    file: "/Users/paulsoulhiard/Desktop/DEV/nuxt-boilerplate/pages/index.vue",
    children: [],
    meta,
...
const router_589e7eab = defineNuxtPlugin((nuxtApp) => {
...
const Error404 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-7371678c"]]);
const _sfc_main$5 = {
  __ssrInlineRender: true,
  props: {
    appName: {
...
const Error500 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-5d1604e8"]]);
const _sfc_main$3 = {
  __ssrInlineRender: true,
  props: {
    error: Object
...
const _sfc_main = {
  ...
  setup(__props) {
    console.log("Hello !");
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<h1${serverRenderer.exports.ssrRenderAttrs(_attrs)}>Hello World !</h1>`);
    };
  }
};
